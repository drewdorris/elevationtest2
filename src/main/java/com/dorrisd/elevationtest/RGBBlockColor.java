...
public class RGBBlockColor {
    ...
    public static void activateBlocks() {
        ...
        new RGBBlockValue(new Color(148, 104, 86), "BRICKS");
        ...
        new RGBBlockValue(new Color(170, 132, 110), new Color(165, 131, 113),
                new Color(166, 131, 115), new Color(157, 127, 115), "COMMAND_BLOCK");
        ...
        new RGBBlockValue(new Color(45, 23, 27), "NETHER_BRICKS");
        ...
        new RGBBlockValue(new Color(122, 122, 12), "STONE_BRICKS");
        new RGBBlockValue(new Color(122, 127, 111), new Color(114, 119, 104),
                new Color(110, 115, 101), new Color(114, 117, 108),
                "STONE_BRICKS", 1);// moss
        new RGBBlockValue(new Color(119, 119, 119), "STONE_BRICKS", 3);// chissle
        if (!isVersionHigherThan(1, 12)) {
            ...
            new RGBBlockValue(new Color(162, 168, 168), "WOOL", DyeColor.LIGHT_GRAY);
            ...
            new RGBBlockValue(new Color(142, 142, 135), "WOOL", DyeColor.LIGHT_GRAY);
        ...
        new RGBBlockValue(new Color(125, 125, 115), "CONCRETE", DyeColor.LIGHT_GRAY);
        ...
        new RGBBlockValue(new Color(69, 4, 7), "RED_NETHER_BRICKS");
